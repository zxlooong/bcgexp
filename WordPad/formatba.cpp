...
CFormatBar::CFormatBar()
{
	...
	CBCGPToolbarFontCombo::m_nFontHeight = m_szBaseUnits.cy;
	m_nNumColours = 0;
}
...
void CFormatBar::OnReset ()
{
	...
	CBCGPToolbarMenuButton* pBorderTypeButton = CreateBorderTypeButton ();
...
CBCGPColorMenuButton* CFormatBar::CreateColorButton ()
{
	...
	CBCGPColorMenuButton* pColorButton = new 
		CBCGPColorMenuButton (ID_CHAR_COLOR, _T("Text Color..."), &m_palColorPicker);
...
CBCGPToolbarMenuButton* CFormatBar::CreateBorderTypeButton ()
{
	CMenu menu;
	...
	CBCGPToolbarMenuButton* pBorderType = new 
		CBCGPToolbarMenuButton (ID_BORDER_1, pPopup->GetSafeHmenu (),
		CImageHash::GetImageOfCommand (ID_BORDER_1, FALSE),
		_T("Borders"));
